...
/*
  ...
  Author: BE API
  Author URI: https://github.com/reggieofarrell/ACF-PHP-Recovery/
  Version: 2.0.0
*/
...
function acf_php_recovery_page() {
	...
	<div class="wrap">
		...
		if (! empty($imported)) {
			...
			<div id="message" class="updated below-h2"><p><?php _e('Fieldsets recovered'); ?>.</p>
				<ul>
					...
					?>
					<li>
						<strong><?php _e('Remove the PHP defined fields! The duplicate field IDs interfer with the editing of the fields.'); ?></strong>
					</li>
				</ul>
			</div>
			<?php
		...
		<p>
			<strong>This is a recovery tool. Do not use this as part of your workflow for importing and exporting ACF fieldsets.</strong>
		</p>
		<form method="POST">
			<table class="widefat">
				<thead>
